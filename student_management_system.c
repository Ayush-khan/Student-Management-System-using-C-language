...
Author:  Ayush khan
Email.Id: ayushkhana230@gmail.com
whasapp No: 8839858154
*/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
int main() // main function start
{
    ...
    char pass[] = {"123"};
    printf("******:::::: NOW STARTING ::::::::**********\n");
    printf("\n\n\t\tplease enter your 3 digit password:> ");
    gets(password);
    ...
    else
    {
        ...
        printf("\n\t\tincorrect password???");
        printf("\n\n1) If you forgot your password prees key 1 ");
        printf("\t\t\t2) Otherwise to press any key except 1 ");

        int key;
        scanf("\n%d", &key);
        if (key == 1)
        {
            printf("/n/n/n YOUR PASSWORD IS 123/n/n ");
        }
        else
